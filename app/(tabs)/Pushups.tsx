    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 110 }}>
      ...
      <View style={styles.headerSection}>
        ...
        <View style={styles.welcomeSection}>
          <Text style={styles.welcomeText}>Push-Ups</Text>
          <Text style={styles.subtitleText}>How strong is your core?</Text>
        </View>
      </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          Linking.openURL('https://www.youtube.com/watch?v=_kL1iuiIjMU').catch(() =>
      ...
      >
        ...
        <View style={styles.workoutTipsContent}>
          ...
          <Text style={styles.workoutTipsDescription}>
            Keep your body straight, engage your core, and lower yourself until your chest nearly touches the floor.
          </Text>
        </View>
      </TouchableOpacity>
