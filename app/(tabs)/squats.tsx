    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 110 }}>
      ...
      <View style={styles.headerSection}>
        ...
        <View style={styles.welcomeSection}>
          <Text style={styles.welcomeText}>Squats</Text>
          <Text style={styles.subtitleText}>How deep can you squat?</Text>
        </View>
      </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          Linking.openURL('https://www.youtube.com/watch?v=aclHkVaku9U').catch(() =>
      ...
      >
        ...
        <View style={styles.workoutTipsContent}>
          ...
          <Text style={styles.workoutTipsDescription}>
            Keep your feet shoulder-width apart, lower your hips as if sitting, keep chest upright, and avoid your knees extending past your toes.
          </Text>
        </View>
      </TouchableOpacity>
