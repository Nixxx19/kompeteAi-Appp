...
export default function HighKneesScreen() {
  ...
  const handleCamera = async () => {
    ...
    if (!result.canceled && result.assets?.length > 0) {
      ...
      setSelectedFile(uri);
      setUploadStep(2);
      Alert.alert('Video Captured', uri.split('/').pop() || 'video file');
    }
  };

  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 110 }}>
      {/* Header Section with KOMPTE logo and tagline */}
      <View style={styles.headerSection}>
        ...
        <View style={styles.welcomeSection}>
          <Text style={styles.welcomeText}>High Knees</Text>
          <Text style={styles.subtitleText}>Ready to burn some calories?</Text>
        </View>
      </View>

      {/* Stepper and Upload Card */}
      ...
      {/* Workout Tips - NEW DESIGN */}
      <Text style={styles.workoutTipsHeading}>Workout Tips</Text>
      <TouchableOpacity
        style={styles.workoutTipsBox}
        onPress={() => {
          Linking.openURL('https://www.youtube.com/watch?v=ZZZoCNMU48U').catch(() =>
      ...
      >
        ...
        <View style={styles.workoutTipsContent}>
          ...
          <Text style={styles.workoutTipsDescription}>
            Focus on keeping your core tight and lifting your knees as high as possible while maintaining a quick pace. 
            Engage your arms to help with the rhythm.
          </Text>
        </View>
      </TouchableOpacity>
